...
from attorney_extractor import AttorneyProfile, EducationRecord, split_education_by_degree
...
def _profile_to_row(profile: AttorneyProfile) -> list[Any]:
    ...
    jd_str, ba_str, llm_str = split_education_by_degree(profile.education)
